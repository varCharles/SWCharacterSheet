...
// export const SWD6WildDiceRoller = ({ children, dice, stat }) => {
...
//     return dice.join(" + ");
//   };
//   const formatWidlDiceContent = ({ total, rolls, wildDieBreakdown }, dice) => {
//     const;
//     return (
...
//     const modalContent = formatWidlDiceContent(results, dice);
...
//   const formatDiceContent = ({ total, rolls }, dice) => {
//     return (
//       <div className="text-center">
//         <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 py-10 sm:px-6 xl:px-8">
//           <dt className="w-full flex-none text-base/6 font-semibold text-gray-500 capitalize">
